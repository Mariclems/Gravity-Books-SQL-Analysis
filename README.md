...
We decided to investigate which book language sells the most to identify customers favorites and stock more book in that same language. We used the following query: 

[Question 1 SQL](queries/question_1.sql)
...
![ Diagram](Images/ERD_diagram.png)
